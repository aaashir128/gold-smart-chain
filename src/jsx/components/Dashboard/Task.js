...
// 				</Modal>
// 				<div>
// 					<Link to={"#"} className="btn btn-secondary sharp rounded-circle me-3"> <i className="fas fa-envelope "></i></Link>
// 					<Link to={"#"} className="btn btn-secondary sharp rounded-circle  me-3"><i className="fas fa-phone-alt"></i></Link>
// 					<Link to={"#"} className="btn btn-primary sharp rounded-circle"><i className="fas fa-info"></i></Link>
// 				</div>
// 			</div>          
//             <div className="row">
...
//                                     <div className="text-dark fs-14 text-nowrap"><i className="fas fa-calendar-alt me-2" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
