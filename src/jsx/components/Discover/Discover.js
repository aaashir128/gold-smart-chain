...
import AllSell2 from "../../pages/WidgetBasic/AllSell2";
import BloodPressur from "../../pages/WidgetBasic/BloodPressure";
import Clolesterol from "../../pages/WidgetBasic/Clolesterol";
import FeeCollection from "../../pages/WidgetBasic/FeeCollection";
import GlucoseRate from "../../pages/WidgetBasic/GlucoseRate";
import HeartRate from "../../pages/WidgetBasic/HeartRate";
import LifeTimeEarning from "../../pages/WidgetBasic/LifeTimeEarning";
import MarketNow from "../../pages/WidgetBasic/MarketNow";
import NewStudent from "../../pages/WidgetBasic/NewStudent";
import PowerBar from "../../pages/WidgetBasic/PowerBar";
import PowerLine from "../../pages/WidgetBasic/PowerLine";
import SalesAnalysis from "../../pages/WidgetBasic/SalesAnalysis";
import TopProducts1 from "../../pages/WidgetBasic/TopProducts1";
import TopProducts2 from "../../pages/WidgetBasic/TopProducts2";
import TotalCourse from "../../pages/WidgetBasic/TotalCourse";
import TotalStudent from "../../pages/WidgetBasic/TotalStudent";
import ViewProject from "../../pages/WidgetBasic/ViewProject";
import VisitorActivity from "../../pages/WidgetBasic/VisitorActivity";
import WeeklySales1 from "../../pages/WidgetBasic/WeeklySales1";
import WeeklySales2 from "../../pages/WidgetBasic/WeeklySales2";
import Widget1 from "../../pages/WidgetBasic/Widget1";
import Widget2 from "../../pages/WidgetBasic/Widget2";
// Page titie
...
const Discover = () => {
  return (
    <Fragment>
      ...
      <h4 className="card-title mb-1">Copy Trade</h4>
      <p className="mb-3">Mirror the portfolios of top investors.</p>
      <div className="row">
        {[1, 2, 3, 4].map(() => {
          return (
            <div className="col-xl-3 col-lg-3 col-xxl-3 col-md-3">
              <div className="card">
                <div className="card-header border-0 pb-0 justify-content-center">
                  <div className="text-center">
                    <img
                      src="https://workload.dexignlab.com/xhtml/images/profile/profile.png"
                      width="100"
                      height="100"
      ...
      <h4 className="card-title mb-1">Daily Mover</h4>
      <p className="mb-3">Today’s biggest gainers and losers.</p>

      <div className="col-xl-12 col-xxl-12 col-md-12 col-lg-12 col-sm-12 row">
        {[1, 2, 3, 4, 5, 6].map(() => {
          return (
            <div className="col-xl-6 col-md-6 col-lg-6 col-sm-6">
              <div className="widget-stat card primary">
                <div className="card-body">
                  <div className="media ai-icon d-flex justify-content-between">
                    <span className="me-3">
                      <img
                        src="https://glebecoins.net/wp-content/uploads/1652696849_Bill-Miller-remains-bullish-on-bitcoin-despite-the-current-crisis.jpg"
                        width="80"
                      ></img>
                    </span>
      ...
      <div className="row">
        {[1, 2, 3, 4, 5, 6].map(() => {
          return (
            <div className="col-xl-2 col-lg-2 col-xxl-2 col-md-2">
              <div className="card">
                <div className="card-header border-0 pb-0 justify-content-center"  height="400">
                  <div className="text-center">
                    <img
                      src="https://workload.dexignlab.com/xhtml/images/avatar/1.jpg"
                      width="100"
                      height="100"
                      className="rounded-circle mb-4 mt-4"
                    ></img>
                    <div className="text-center mt-5 mb-5">
                      <h3 className="card-title">TGL</h3>
                      <h3 className="card-title">$123,43.00</h3>
                      <span>+34%</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
          <div className="card text-white bg-warning text-black">
            <ul className="list-group list-group-flush">
              ...
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0">Dr Eric Discover :</span>
